...
class TestCase extends Start1 {
	...
	@Test
	void test_For_Signed_1bit_Integer() {
		Convert con = new Convert();
	...
	@Test
	void test_For_Signed_2bit_Integer() {
		Convert con = new Convert();
	...
	@Test
	void test_For_Signed_4bit_Integer() {
		Convert con = new Convert();
	...
	@Test
	void test_For_Signed_8bit_Integer() {
		Convert con = new Convert();
	...
	@Test
	void test_For_Signed_16bit_Integer() {
		Convert con = new Convert();
